...
static const group_sequence_t macro_sequence = {
    .list = {
        ...
        // {
        //     .list = {{50000, ONE_KEYBOARD_KEY(HID_KEY_A)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_B)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_C)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_D)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_E)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_F)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_G)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_H)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_I)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_J)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_K)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_L)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_M)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_N)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_O)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_P)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_Q)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_R)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_S)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_T)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_U)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_V)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_W)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_X)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_Y)}, {50000, ONE_KEYBOARD_KEY(HID_KEY_Z)}, {0, EMPTY_KEYBOARD}},
        //     .size = 27,
        //     .event_press = ONE_MOUSE_KEY(MOUSE_BUTTON_RIGHT),
        // },
        {
