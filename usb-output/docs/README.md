...
All available docs under this folder:

- [Quick Walkthrough](./QUICK_WALKTHROUGH.md)
...
- `mouse_only_example.json`, `example_v2_multiscript.json`, `example_interp_additive.json`
